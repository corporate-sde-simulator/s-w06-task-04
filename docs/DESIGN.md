# Architecture Decision Record - Password policy enforcement service
...
Implement Password policy enforcement service using industry-standard patterns appropriate for java and our platform requirements.
